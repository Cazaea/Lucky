...
import com.cazaea.camera.listener.CaptureListener;
...
import com.cazaea.camera.listener.TypeListener;
import com.cazaea.camera.state.CameraMachine;
import com.cazaea.camera.util.FileUtil;
import com.cazaea.camera.util.LogUtil;
import com.cazaea.camera.util.ScreenUtils;
import com.cazaea.camera.view.CameraHelper;
...
public class CameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
        .Callback, CameraHelper {
//    private static final String TAG = "JBaseCamera";
...
//        });
    ...
    public void onResume() {
        LogUtil.i("JBaseCamera onResume");
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        LogUtil.i("JBaseCamera SurfaceCreated");
        new Thread() {
            @Override
            public void run() {
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        LogUtil.i("JBaseCamera SurfaceDestroyed");
